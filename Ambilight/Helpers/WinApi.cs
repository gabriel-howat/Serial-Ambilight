...
namespace Ambilight.Helpers
{
    public class WinAPI
    {
        ...
        public static System.Drawing.Rectangle GetTrayRectangle()
        {
            WinAPI.RECT rect;
            WinAPI.GetWindowRect(WinAPI.GetTrayHandle(), out rect);
            return new System.Drawing.Rectangle(new System.Drawing.Point(rect.left, rect.top), new Size((rect.right - rect.left) + 1, (rect.bottom - rect.top) + 1));
        }
    }
}
